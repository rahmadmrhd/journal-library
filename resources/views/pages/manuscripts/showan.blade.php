...
<x-app-layout sizeHideSidebar="xl" title="Detail Manuscript">
  ...
  <div class="card">
    <div class="pb-2 border-b-2 border-gray-200 dark:border-gray-700">
      <h1 class="text-xl font-extrabold sm:text-2xl lg:text-4xl">#{{ $manuscript->code }}</h1>
    </div>

    <div class="mt-6 detail-box">
      <div class="row">
      ...
      <div class="row">
        ...
        <div class="column">
          <ul class="flex flex-wrap justify-end w-full max-w-full gap-2" focusable
            ...
            @foreach ($manuscript->keywords->pluck('name') as $keyword)
              <li
                ...
                <span
                  class="px-2 py-1 text-sm border-gray-100 text-ellipsis dark:border-gray-700">{{ $keyword }}</span>
              </li>
            @endforeach
          </ul>
        </div>
      ...
      <x-slot name="authors">
        <x-table :columns="[
          ...
          @foreach ($manuscript->authors as $author)
            <tr class="bg-white border-b hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-600">
              <td valign="top" class="px-6 py-2 truncate max-w-64px">
  ...
  <div class="mt-6 card">
    <div class="pb-2 mb-3 border-b border-gray-300 dark:border-gray-700">
      <h3 class="text-xl font-extrabold text-left lg:text-3xl">
        Progress
      </h3>
    </div>
    <x-tabs-panel class="mt-3" :withFragment="true" :tabs="[
      ...
      <x-slot name="editor">
        ...
        <div class="w-full h-auto px-4 pb-2 mt-4 rounded-lg shadow-md bg-gray-50 dark:bg-gray-700">
          <x-table :columns="[
  ...
  <div class="mt-6 card">
    <div class="pb-2 mb-2 border-b border-gray-300 dark:border-gray-700">
      <h3 class="text-xl font-extrabold text-left lg:text-3xl">
        Your Decision
      </h3>
      <p class="mt-2 text-sm italic font-thin">
    ...
    @endif
    <form class="mt-3 space-y-3" action="" method="POST">
      @csrf
      @method('PUT')
      <x-text-input id="decision" type="select" label="Decision" name="decision" required>
        <option value="" disabled selected>-- Select Decision --</option>
        <option value="accept">Accept</option>
        <option value="reject">Reject</option>
      </x-text-input>
      <x-text-editor id="notes" label="Notes" name="notes" variable="notes">
      </x-text-editor>

      <x-files label="File Attachments">
      </x-files>
      <div class="flex items-center justify-end gap-2 py-2 mt-4 border-t border-gray-300 dark:border-gray-700">
